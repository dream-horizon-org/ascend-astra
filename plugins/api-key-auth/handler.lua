...
-- Error codes
local ERROR_CODES = {
    MISSING_API_KEY = "AK-1001",
    INVALID_API_KEY = "AK-1002",
    EXPIRED_API_KEY = "AK-1003",
    DATABASE_ERROR = "AK-1004",
    PROJECT_NOT_FOUND = "AK-1005",
    TENANT_INACTIVE = "AK-1006",
    PROJECT_INACTIVE = "AK-1007",
}
